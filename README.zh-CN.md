...
测试使用离线 DNS 报文与本地 UDP/TCP/TLS/HTTPS/QUIC 服务。CI 配置覆盖 macOS/Linux 的 Python 3.11/3.14，并保留可见的 Windows 实验性任务；配置存在不代表已经在这些平台实测通过。本机记录见 [验证](docs/VALIDATION-1.2.md)。
